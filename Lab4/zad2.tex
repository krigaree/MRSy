...
\NormalTok{f = @(x) }\FunctionTok{cos}\NormalTok{(x);}
\NormalTok{g = @(x) -}\FloatTok{1}\NormalTok{/}\FloatTok{10} \NormalTok{* (}\FunctionTok{sin}\NormalTok{(x) + }\FloatTok{3}\NormalTok{* }\FunctionTok{cos}\NormalTok{(x));}
\NormalTok{a = }\FloatTok{0}\NormalTok{;}
\NormalTok{b = }\BaseNTok{pi}\NormalTok{/}\FloatTok{2}\NormalTok{;}
\NormalTok{ax = @(x) }\FloatTok{1}\NormalTok{;}
\NormalTok{bx = @(x) -}\FloatTok{1}\NormalTok{;}
\NormalTok{cx = @(x) -}\FloatTok{2}\NormalTok{;}
\NormalTok{ua =-}\FloatTok{3}\NormalTok{/}\FloatTok{10}\NormalTok{;}
\NormalTok{ub = -}\FloatTok{1}\NormalTok{/}\FloatTok{10}\NormalTok{;}
\NormalTok{c = b-a;}
