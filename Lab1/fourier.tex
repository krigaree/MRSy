...
\begin{figure}[!ht]
	\begin{center}
\includegraphics[width=0.9\textwidth]{Lab1/charts/Figure_1.png}
	\end{center}
\end{figure}
\begin{figure}[!ht]
	\begin{center}
\includegraphics[width=0.9\textwidth]{Lab1/charts/Figure_2.png}
	\end{center}
\end{figure}
\begin{figure}[!ht]
	\begin{center}
\includegraphics[width=0.9\textwidth]{Lab1/charts/Figure_3.png}
	\end{center}
\end{figure}
\FloatBarrier
